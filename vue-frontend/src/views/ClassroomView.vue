...
const codeModalEnabled = ref(false)
...
<template>
  <div class="bg-soft-white dark:bg-soft-black">
    ...
    <div class="w-full justify-center flex">
      <div class="w-3/4 bg-gray-200 dark:bg-slate-500 h-screen">
        <div name="title, desc and teacher btns" class="py-2 w-full px-2 flex flex-row justify-between">
          <div name="classroom details" class="text-black dark:text-darkMode">

            <div name="name" class="flex flex-row py-3">
              ...
              <div v-if="!showName" class="flex flex-row">
                <input type="text" v-model="classroomName"
                  class="text-6xl text-black flex-grow bg-transparent outline-none"
          ...
          <span name="teacher btns" v-if="userRole === 'teacher'" class="py-2 gap-2 flex h-fit">
            ...
            <button @click="createTaskModal = true"
              class="text-center bg-blue-400 hover:bg-blue-600 hover:text-black rounded-md text-2xl px-4">
              + Create Task
            </button>
            <button @click="codeModalEnabled = true" class="text-center text-2xl bg-gray-300 rounded-md px-2 text-gray-900">
              + Add a student
            </button>
          </span>
        </div>
        ...
        <!-- MODALS -->
        <Modal v-model="codeModalEnabled">
        ...
        <div name="content" class="flex flex-row">
          ...
          <div v-for="(item, index) of classroomQuizzes" :key="index" class="py-2 flex flex-col w-full">
            ...
            <RouterLink :to="{ path: route.params.classroomId + '/quiz/' + item.id }"
              class="hover:bg-gray-400 ease-in-out duration-200 mx-10 flex flex-col rounded-md shadow-md bg-soft-white text-gray-900 dark:text-darkMode border-gray-200 dark:bg-gray-500 dark:border-none dark:hover:text-gray-800 p-2 cursor-pointer group">
