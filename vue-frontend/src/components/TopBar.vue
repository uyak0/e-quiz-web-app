...
<template>
  <div class="sticky font-jetBrains flex flex-rows text-2xl justify-between px-2 py-1 bg-gray-600 place-items-center">
    <div name="left modules" class="">
      ...
      <button @click="modalEnabled = !modalEnabled" v-if="userRole === 'student' && pageName.includes('Home') && enableButton" class="ml-2 bg-blue-300 hover:bg-blue-600 duration-150 ease-in hover:text-white text-black rounded-md px-2">
        + Join a classroom 
      </button>
